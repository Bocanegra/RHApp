...
- (void)motionEnded:(UIEventSubtype)motion withEvent:(UIEvent *)event {
    if (motion == UIEventSubtypeMotionShake) {
        // Se ha producido una sacudida, para deshacer
        if ([self.fetchedResultsController.managedObjectContext.undoManager canUndo] ||
            [self.fetchedResultsController.managedObjectContext.undoManager canRedo]) {
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Deshacer/rehacer"
                                                                           message:@"Elige qué deseas hacer"
                                                                    preferredStyle:UIAlertControllerStyleAlert];
            if ([self.fetchedResultsController.managedObjectContext.undoManager canUndo]) {
                UIAlertAction *undo = [UIAlertAction actionWithTitle:@"Deshacer"
            ...
            if ([self.fetchedResultsController.managedObjectContext.undoManager canRedo]) {
                UIAlertAction *redo = [UIAlertAction actionWithTitle:@"Rehacer"
                                                               style:UIAlertActionStyleDefault
                                                             handler:^(UIAlertAction *action)
                                       {
